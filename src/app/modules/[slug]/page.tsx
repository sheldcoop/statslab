        ...
        items: [
          {
            ...
            description: 'Summarizing data with mean, median, mode, and variance.',
          },
          {
            icon: Sigma,
        ...
        items: [
          {
            ...
            description: 'Formulating and testing claims with data (p-values, etc.).',
          },
          {
            icon: Waypoints,
        ...
        <div className="container mx-auto text-center">
           <h2 className="font-headline text-4xl font-bold tracking-tight sm:text-5xl">
            ...
            <p className="mt-4 max-w-xl mx-auto text-muted-foreground">
              The best way to learn is by doing. Launch the terminal to start experimenting with these concepts right away.
            </p>
...
// Added ArrowRight to imports since it's used in the CTA button.
